...
var HierarchicalKey = function(bytes) {
  if (typeof bytes == 'undefined' || bytes == 'mainnet' || bytes == 'exccdlivenet') {
    bytes = 'exccdlivenet';
    this.version = networks['exccdlivenet'].hkeyPrivateVersion;
  } else if (bytes == 'exccdtestnet') {
    this.version = networks['exccdtestnet'].hkeyPrivateVersion;
  }
  if (bytes == 'exccdlivenet' || bytes == 'exccdtestnet') {
    this.depth = 0x00;
...
HierarchicalKey.prototype.initFromBytes = function(bytes) {
  ...
  var isPublic =
    (this.version == networks['exccdlivenet'].hkeyPublicVersion ||
      this.version == networks['exccdtestnet'].hkeyPublicVersion);
...
HierarchicalKey.prototype.buildExtendedPublicKey = function() {
  ...
  var v = null;
  switch (this.version) {
    case networks['exccdlivenet'].hkeyPublicVersion:
    case networks['exccdlivenet'].hkeyPrivateVersion:
      v = networks['exccdlivenet'].hkeyPublicVersion;
      break;
    case networks['exccdtestnet'].hkeyPublicVersion:
    case networks['exccdtestnet'].hkeyPrivateVersion:
      v = networks['exccdtestnet'].hkeyPublicVersion;
      break;
    default:
