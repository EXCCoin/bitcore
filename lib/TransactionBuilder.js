...
TransactionBuilder.infoForP2sh = function(opts, networkName) {
  ...
  var version = networkName === 'exccdtestnet' ?
    networks.exccdtestnet.P2SHVersion : networks.exccdlivenet.P2SHVersion;
...
TransactionBuilder.prototype._multiFindKey = function(walletKeyMap, pubKeyHash) {
  var wk;
  [networks.exccdlivenet, networks.exccdtestnet].forEach(function(n) {
